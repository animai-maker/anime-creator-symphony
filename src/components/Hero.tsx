...
const Hero = () => {
  return (
    <div className="flex flex-col items-center justify-center text-center py-16 px-4">
      <h1 className="text-4xl md:text-6xl font-bold text-animai-navy mb-6">
        AI-Powered Anime Movie Editor
      </h1>
      <p className="text-xl md:text-2xl text-gray-700 max-w-3xl mb-12">
        Transform images, voice, and background music into cinematic anime shorts
      </p>
